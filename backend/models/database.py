...
# Replace the Alert class in backend/models/database.py
...
class Alert(Base):
    ...
    raw_risk_score = Column(Integer, nullable=True)     # NEW: For confidence calculation
    confidence_level = Column(String(50), nullable=True) # NEW: High, Medium, Low
    alert_type = Column(String(100), nullable=False)
    alert_reasons = Column(Text, nullable=True)          # NEW: Pipe-separated list of triggered rules
