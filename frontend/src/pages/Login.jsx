...
const Login = () => {
  ...
  const { login } = useContext(AuthContext); // Bring in global state manager
  ...
  const handleAuth = async (e) => {
    ...
    try {
      ...
      // Update Global State using the Context we built earlier
      login(token, activeRole);

      // THE ROUTER ALGORITHM: Admin vs Maker/Checker
      if (activeRole === 'Admin') {
  ...
  // ==========================================
  // UI REMAINS 100% UNTOUCHED BELOW THIS LINE
  // ==========================================
