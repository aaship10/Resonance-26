...
const Dashboard = () => {
  ...
  const sortedAlerts = [...alerts].sort((a, b) => {
    ...
    if (sortConfig.key === 'score') {
      ...
      // Using updated_at for sorting so rejected cases jump to top
    ...
    <div className="bg-surface font-body text-on-surface min-h-screen relative overflow-x-hidden">
      ...
      <main className="lg:pl-[220px] pt-24 px-8 pb-12 min-h-screen">
        ...
        <section className="mt-12">
          ...
          <div className="grid grid-cols-6 px-8 py-4 mb-2 text-xs font-bold text-outline-variant uppercase tracking-widest text-on-surface-variant">
            <span>Alert ID</span>
            <span className="col-span-2">Entity Name</span>
            <span>Risk Score</span>
            <span>Alert Type</span>
          ...
          <div className="space-y-4">
            ...
            {isLoading ? (
              ...
              /* REMOVED .slice(0, 3) - All alerts are now visible */
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      {alert.status === 'REJECTED' && (
                        <span className="bg-red-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full w-fit animate-pulse tracking-tighter">
                          ⚠️ REJECTED
                        </span>
                      )}
                    </div>
                    <div className="flex items-center justify-end space-x-4">
                      <span className="text-xs text-on-surface-variant font-medium whitespace-nowrap">
                        {new Date(alert.updated_at || alert.created_at).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                      </span>
