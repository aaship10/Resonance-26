...
const Dashboard = () => {
  ...
  // Active Analyst Dashboard based on provided HTML
  return (
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-1">
            ...
            <div className="w-8 h-8 rounded-full overflow-hidden ml-2 border border-outline-variant/30">
              <img className="w-full h-full object-cover" alt="Analyst Profile" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDtckIJBDXMfHX0SuV7_c3SF0iIyXL8CEb9G90cUIxPAV07ozXEQw9PWUTcbrrMHm_0kQv0B0ICbUiWWVrwl5ZFU6mpn02sb6SL-HwRzNhvqc1o6UKnWyaCXXjBPNHTUSAWotHDYB3glUkQr7Gq8CNAM0GSY6qDuV9HLUlQmpKKwajwAog8RU7KX7QFW4pAF3jhRVGtnow8omV6parkU5PTMpEdcYKOWaSNeCeqW6aIBqtc5huJtVbyfU3ClhdnWawg6Sb1fJuDmhmG"/>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="lg:pl-[220px] pt-24 px-8 pb-12 min-h-screen">
        ...
        <section className="mt-12">
          <div className="flex justify-between items-end mb-8">
            <div>
              <h2 className="text-2xl font-black text-on-surface font-display tracking-tight">Active Alert Queue</h2>
          ...
          <div className="space-y-4">
            {/* Row 1: Hover State Focus */}
            <div className="grid grid-cols-6 items-center px-8 py-5 neomorphic-raised rounded-2xl bg-surface transition-all duration-300 ring-2 ring-primary-container/40 shadow-[0_0_20px_rgba(211,197,224,0.4)] scale-[1.01] relative z-10 cursor-pointer">
              <span className="font-bold text-primary font-display">AL-8842-X</span>
              <div className="col-span-2 flex items-center space-x-3">
                <div className="w-10 h-10 rounded-full neomorphic-recessed flex items-center justify-center text-xs font-bold text-on-surface shadow-sm">GM</div>
                <div>
                  <p className="font-bold text-on-surface">Global Merchants LLC</p>
                  <p className="text-xs text-on-surface-variant">Merchant Account • Cayman Islands</p>
                </div>
              </div>
              <div className="pr-8">
                <div className="h-2 w-full bg-surface-container-high rounded-full overflow-hidden shadow-inner">
                  <div className="h-full bg-gradient-to-r from-tertiary-container to-error w-[88%] rounded-full"></div>
                </div>
                <span className="text-[10px] font-black text-error mt-1 block">CRITICAL 88/100</span>
              </div>
              <div>
                <span className="px-3 py-1 bg-tertiary-container/60 text-tertiary rounded-full text-[11px] font-bold shadow-[1px_1px_3px_rgba(0,0,0,0.05),-1px_-1px_3px_rgba(255,255,255,0.5)]">KYC Deviation</span>
              </div>
              <div className="flex items-center justify-end space-x-4">
                <span className="text-xs text-on-surface-variant font-medium">14:22:10 UTC</span>
                <button onClick={() => navigate('/investigation')} className="neomorphic-pill px-4 py-2 rounded-xl text-primary text-xs font-bold flex items-center gap-1 hover:brightness-105 active:scale-95 transition-all">
                  Investigate
                </button>
              </div>
            </div>
            ...
            {/* Row 2 */}
            <div className="grid grid-cols-6 items-center px-8 py-5 neomorphic-raised rounded-2xl bg-surface hover:translate-y-[-2px] transition-all duration-300 cursor-pointer">
              <span className="font-bold text-on-surface-variant font-display">AL-8841-B</span>
              <div className="col-span-2 flex items-center space-x-3">
                <div className="w-10 h-10 rounded-full neomorphic-recessed flex items-center justify-center text-xs font-bold text-on-surface shadow-sm">JD</div>
                <div>
                  <p className="font-bold text-on-surface">Jane Doe</p>
                  <p className="text-xs text-on-surface-variant">Personal Banking • United Kingdom</p>
                </div>
              </div>
              <div className="pr-8">
                <div className="h-2 w-full bg-surface-container-high rounded-full overflow-hidden shadow-inner">
                  <div className="h-full bg-gradient-to-r from-[#d1cfda] to-secondary w-[42%] rounded-full"></div>
                </div>
                <span className="text-[10px] font-black text-secondary mt-1 block">LOW 42/100</span>
              </div>
              <div>
                <span className="px-3 py-1 bg-secondary-container/60 text-secondary rounded-full text-[11px] font-bold shadow-[1px_1px_3px_rgba(0,0,0,0.05),-1px_-1px_3px_rgba(255,255,255,0.5)]">High-Velocity</span>
              </div>
              <div className="flex items-center justify-end space-x-4">
                <span className="text-xs text-on-surface-variant font-medium">13:58:02 UTC</span>
            ...
            {/* Row 3 */}
            <div className="grid grid-cols-6 items-center px-8 py-5 neomorphic-raised rounded-2xl bg-surface hover:translate-y-[-2px] transition-all duration-300 cursor-pointer">
              <span className="font-bold text-on-surface-variant font-display">AL-8840-Z</span>
              <div className="col-span-2 flex items-center space-x-3">
                <div className="w-10 h-10 rounded-full neomorphic-recessed flex items-center justify-center text-xs font-bold text-on-surface shadow-sm">SR</div>
                <div>
                  <p className="font-bold text-on-surface">Solaris Resources Inc</p>
                  <p className="text-xs text-on-surface-variant">Corporate Treasury • Singapore</p>
                </div>
              </div>
              <div className="pr-8">
                <div className="h-2 w-full bg-surface-container-high rounded-full overflow-hidden shadow-inner">
                  <div className="h-full bg-gradient-to-r from-secondary-container via-primary-container to-tertiary w-[65%] rounded-full"></div>
                </div>
                <span className="text-[10px] font-black text-tertiary mt-1 block">MEDIUM 65/100</span>
              </div>
              <div>
                <span className="px-3 py-1 bg-surface-container-high text-on-surface-variant rounded-full text-[11px] font-bold shadow-[1px_1px_3px_rgba(0,0,0,0.05),-1px_-1px_3px_rgba(255,255,255,0.5)]">Structuring</span>
              </div>
              <div className="flex items-center justify-end space-x-4">
                <span className="text-xs text-on-surface-variant font-medium">13:45:11 UTC</span>
                <button className="p-2 rounded-full text-on-surface-variant hover:bg-surface-container-high transition-colors">
                  <span className="material-symbols-outlined">more_vert</span>
                </button>
              </div>
             ...
             {/* Row 4 */}
             <div className="grid grid-cols-6 items-center px-8 py-5 neomorphic-raised rounded-2xl bg-surface hover:translate-y-[-2px] transition-all duration-300 cursor-pointer">
              <span className="font-bold text-on-surface-variant font-display">AL-8839-A</span>
              <div className="col-span-2 flex items-center space-x-3">
                <div className="w-10 h-10 rounded-full neomorphic-recessed flex items-center justify-center text-xs font-bold text-on-surface shadow-sm">KB</div>
                <div>
                  <p className="font-bold text-on-surface">Kevin Baker</p>
                  <p className="text-xs text-on-surface-variant">Private Client • Switzerland</p>
                </div>
              </div>
              <div className="pr-8">
                <div className="h-2 w-full bg-surface-container-high rounded-full overflow-hidden shadow-inner">
                  <div className="h-full bg-gradient-to-r from-tertiary-container to-error w-[92%] rounded-full"></div>
                </div>
                <span className="text-[10px] font-black text-error mt-1 block">CRITICAL 92/100</span>
              </div>
              <div>
                 <span className="px-3 py-1 bg-tertiary-container/60 text-tertiary rounded-full text-[11px] font-bold shadow-[1px_1px_3px_rgba(0,0,0,0.05),-1px_-1px_3px_rgba(255,255,255,0.5)]">Sanctions Hit</span>
              </div>
              <div className="flex items-center justify-end space-x-4">
                <span className="text-xs text-on-surface-variant font-medium">12:12:44 UTC</span>
                <button className="p-2 rounded-full text-on-surface-variant hover:bg-surface-container-high transition-colors">
                  <span className="material-symbols-outlined">more_vert</span>
                </button>
              </div>
