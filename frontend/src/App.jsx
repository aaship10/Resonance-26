...
/>
          ...
          <Route 
            path="/archive" 
            element={<ProtectedRoute role={['Analyst', 'Approver']}><Archive /></ProtectedRoute>} 
          />

          {/* THE DETAIL VIEW (Add this if it's missing or named differently) */}
          <Route 
            path="/editor/:alertId" 
            element={<ProtectedRoute role={['Analyst', 'Approver']}><NarrativeEditor /></ProtectedRoute>} 
          />
